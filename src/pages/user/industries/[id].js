const EachIndustry = () => {
  return (
    <div className=" mx-auto px-4 py-12 text-center">
      ...
      <p className="text-gray-600 mb-10 px-20">
      ...
      <div className=" flex items-center justify-center mb-6">
        <img src="/image19.png" className="w-1/2" />
      </div>

      <div className="flex justify-center gap-6 text-left mx-10">
        {/* Use Case Section */}
        <div className="shadow-lg p-4 rounded-lg w-1/3 flex flex-col gap-1">
        ...
        <div className="shadow-lg p-4 rounded-lg w-1/3">
